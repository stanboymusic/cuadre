// Cálculos puros del módulo Estados (sin DOM). Campos reales: products.stock / cost / name.
(function () {
  const hoyISO = () => new Date().toISOString().replace("T", " ")
  ...
  // Esto es lo que debe usar patrimonio.js; si solo suma products.stock, el patrimonio "cae" al despachar.
